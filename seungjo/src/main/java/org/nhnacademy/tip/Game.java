...
public class Game extends JFrame {
    ...
    public Game(int width, int height) {
        ...
        // TODO: GRAVITY SLIDER 0G -> 무중력, 1G 지구(default)
        JSlider gravitySlider = new JSlider();
        gravitySlider.setOrientation(SwingConstants.VERTICAL);
        gravitySlider.setBounds(world.getX() + world.getWidth() + 60, world.getY(), 50, world.getHeight());
        ...
        windSlider.setBounds(world.getX() + world.getWidth() + 110, world.getY(), 50, world.getHeight());
